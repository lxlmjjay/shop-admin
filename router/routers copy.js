    ...
    children: [
      {
        ...
        component: () => import('@/view/shop/my_store.vue')
      },
      {
        path: 'goods-list',
        name: 'goods_list',
        ...
        component: () => import('@/view/shop/goods_list.vue')
      },
      {
        path: 'goods-add',
        name: 'goods_add',
        ...
        component: () => import('@/view/shop/goods_add.vue')
      },
      {
        path: 'goods-edit',
        name: 'goods_edit',
        ...
        component: () => import('@/view/shop/goods_edit.vue')
      },
      {
        path: 'goods-sku',
        name: 'goods_sku',
        ...
        component: () => import('@/view/shop/goods_sku.vue')
      },
    ]
  },
];
